<template>
  ...
  <section class="section section-article-write-form px-2">
    <div class="container mx-auto">
      ...
      <div v-if="state.article.id !== undefined" class="flex my-10 bg-white px-9 py-2 shadow-md rounded-lg overflow-hidden mx-auto">
              ...
              <div class="flex flex-col mb-2 ml-4 mt-1">
                ...
                <div class="flex w-full mt-1">
                  <router-link :to="'list?boardId' + state.article.boardId" class="text-blue-700 font-base text-xs mr-1 cursor-pointer">
                    {{ state.article.boardId == 1 ? "NOTICE" : "FREE" }}
                  </router-link>
